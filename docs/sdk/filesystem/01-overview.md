...
*   **[读写文件](02-read-and-write.md)**：直接写入文本或字节数据，读取文件内容。
*   **[元数据查看](03-file-and-directory-metadata.md)**：检索文件大小、权限及修改时间。
*   **[目录监控](04-watch-directory-for-changes.md)**：实时监听目录下产生的任何文件变更（类似 `inotify`）。
*   **[数据上传](05-upload-data.md)**：将本地文件或二进制流批量传输至沙箱。
*   **[数据下载](06-download-data.md)**：从沙箱中回传生成的结果文件。
