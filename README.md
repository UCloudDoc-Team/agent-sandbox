...
4. [切换地域](/agent-sandbox/docs/region.md) - 学习如何切换地域
...
| **多地域切换** | 支持在不同地域创建沙箱 | [切换地域](/agent-sandbox/docs/region.md) |
...
| **数据持久化** | 挂载远程存储桶 | [持久化](/agent-sandbox/docs/sdk/sandbox/04-persistence.md) |
